package com.yjhs.documentviewer.fileviewer.tbs;
...
import com.yjhs.documentviewer.R;
import com.yjhs.documentviewer.utils.FileViewerUtils;
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    private void displayFile(String fileAbsPath) {
        String tbsReaderTemp = Environment.getExternalStorageDirectory().getPath()+ "/TbsReaderTemp";
    ...
    private String parseFormat(String fileName) {
        ...
        Log.d("print", "paramString:" + fileName);

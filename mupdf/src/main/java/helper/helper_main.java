...
//            Uri contentUri = FileProvider.getUriForFile(activity, activity.getApplicationContext().getPackageName() + ".provider", file);
            Uri contentUri = FileProvider.getUriForFile(activity, "de.baumann.pdfcreator.pdfview.provider", file);
...
//                Uri uri2 = Uri.fromFile(pathFile);
//                Intent intent2 = new Intent(activity, MuPDFActivity.class);

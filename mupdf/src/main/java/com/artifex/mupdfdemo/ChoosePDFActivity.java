...
public class ChoosePDFActivity extends ListActivity {
	static public final String PICK_KEY_FILE = "com.artifex.com.artifex.mupdfdemo.PICK_KEY_FILE";
	static private File  mDirectory;
	static private final Map<String, Integer> mPositions = new HashMap<String, Integer>();
						...
						switch (mPurpose) {
							case PickPDF:
								...
								if (fname.endsWith(".jfif"))
									return true;
								return fname.endsWith(".jfif-tbnl") || fname.endsWith(".tif") || fname.endsWith(".tiff");
							case PickKeyFile:

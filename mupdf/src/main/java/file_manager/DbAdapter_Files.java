...
class DbAdapter_Files {
    ...
    DbAdapter_Files(Context context) {
        this.c = context;
    }
    ...
    void insert(String files_title, String files_content, String files_icon, String files_attachment, String files_creation) {
    ...
    boolean isExist(String files_title){
